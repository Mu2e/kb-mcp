...
class EvalGeneration(Base):
    """Metadata about how evaluation questions were generated."""
...
class EvalDataset(Base):
    """Individual evaluation questions/queries."""
...
class EvalAudit(Base):
    """Audit/review records for evaluation questions."""
...
class EvalRun(Base):
    """Configuration for an evaluation run/experiment."""
...
class EvalResult(Base):
    """Individual evaluation result for a question in a run."""
...
class EvalRetrievedDocument(Base):
    """Documents retrieved for an evaluation result."""
